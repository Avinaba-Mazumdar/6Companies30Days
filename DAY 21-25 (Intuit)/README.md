...
4. [Largest Number in K Swaps](https://practice.geeksforgeeks.org/problems/largest-number-in-k-swaps-1587115620/1)
...
8. [Number of Boomerangs](https://leetcode.com/problems/number-of-boomerangs/)
9. [Pacific Atlantic Waterflow](https://leetcode.com/problems/pacific-atlantic-water-flow/)
10. [Number of Provinces](https://leetcode.com/problems/number-of-provinces/)
11. [Construct Quad Tree](https://leetcode.com/problems/construct-quad-tree/)
12. [Course Schedule II](https://leetcode.com/problems/course-schedule-ii/)
13. [Minimum Swaps to average a Binary Grid](https://leetcode.com/problems/minimum-swaps-to-arrange-a-binary-grid)
14. [As far from Land as Possible](https://leetcode.com/problems/as-far-from-land-as-possible/)
15. [Koko Eating Bananas](https://leetcode.com/problems/koko-eating-bananas/)